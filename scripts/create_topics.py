...
# Construir una tabla que contiene el identificador del texto junto a su tópico
topics_dic = {
    "id_phrase": df_filtrado.id_phrase[indices],
    "topic": labels
    }

df_topics= pd.DataFrame(topics_dic ).reset_index()
...
# GUARDAR DATOS #
#################
df_topics.to_feather("data/predicted_topics.feather")
