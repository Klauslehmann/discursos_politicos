...
# ¿Cómo ha evolucionado el discurso parlamentario en Chile? ¿Se ha vuelto más emotivo o más racional? {.center}
...
![](images/api-camara.png){fig-align="center" width="900px" height="450px"}
...
plot_timeline_camaras <- ambas_camaras  %>% 
  ...
  labs(x = "fecha", y = "emotividad/cognición") +
  theme_bw() +
...
- Categorías de referencia: hombre, diputado, educación, derecha y predictadura.
...
- Categorías de referencia: mujer, educación, derecha
