...
subtitle: "Emotividad y polarización política en discursos parlamentarios chilenos: 1965 a 2022"
format: 
    revealjs:
      auto-stretch: false
      scrollable: true
...
# ¿Cómo ha evolucionado el discurso parlamentario en Chile? ¿Se ha vuelto más emotivo o más racional?  {.center background-color="aquamarine"}
...
- Estudios de comportamiento político basados en votaciones en sala (NOMINATE)
...
- Los proyectos de ley exitosos presentan una mayor colaboración entre coaliciones, en comparación con el total de los trámites legislativos, para el periodo 2007-2017 (Le Foulon, 2020)

- En la etapa inicial de los proyectos hay menos restricciones políticas, lo cual facilita la cooperación entre posturas ideológicas distantes (Alemán, 2008). 
